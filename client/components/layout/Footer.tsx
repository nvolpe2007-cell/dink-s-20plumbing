  ...
  return (
    <footer className="border-t bg-card text-card-foreground">
      <div className="container py-8 grid gap-3 sm:grid-cols-3 items-center text-sm">
        <div className="font-semibold">© {new Date().getFullYear()} <span className="pipe-font brand-interactive text-lg sm:text-xl md:text-2xl font-extrabold">Dink's Plumbing</span></div>
